        ...
        {products.map(product => (
          <div key={product.id} className="bg-surface/50 backdrop-blur-sm border border-white/5 rounded-2xl p-5 hover:border-primary/30 transition-all group">
            <div className="flex justify-between items-start mb-4">
              <div className="w-24 h-24 bg-gradient-to-br from-white/10 to-white/5 rounded-2xl flex items-center justify-center text-zinc-400 overflow-hidden relative border border-white/10 shadow-inner group-hover:scale-105 transition-transform duration-500">
    ...
    <div className="bg-surface/50 backdrop-blur-xl border border-white/5 rounded-3xl p-8 animate-slide-up">
      <div className="flex justify-between items-center mb-8 border-b border-white/5 pb-6">
        ...
        <div className="flex gap-3">
          <button 
            onClick={onCancel}
            className="px-4 py-2 text-zinc-400 hover:text-white hover:bg-white/5 rounded-xl transition-colors"
          >
            انصراف
          </button>
          <button 
            ...
            <div className="bg-black/20 p-6 rounded-2xl border border-white/5">
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                {product.sizes.map((size, index) => (
                  <div key={index} className="flex items-center gap-2 bg-surface px-3 py-1.5 rounded-lg border border-white/10">
        ...
        {activeTab === 'colors' && (
          <div className="space-y-4 animate-fade-in">
              ...
              <div key={index} className="flex gap-4 items-end bg-black/20 p-4 rounded-xl border border-white/5">
                <div className="flex-1 space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-surface border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-primary/50"
                  />
                </div>
                <div className="flex-1 space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <input 
                      ...
                      className="flex-1 bg-surface border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-primary/50"
                    />
                  </div>
                </div>
                <button 
            ...
            <button 
              ...
              className="w-full py-3 border border-dashed border-white/20 rounded-xl text-zinc-400 hover:text-white hover:border-white/40 transition-all flex items-center justify-center gap-2"
            >
              <Plus size={18} />
              ...
              <div key={index} className="bg-black/20 p-6 rounded-2xl border border-white/5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-surface border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-primary/50 font-mono"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2 mb-6">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-surface border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-primary/50 font-mono h-24"
                    ...
                    {['top', 'left', 'width', 'height'].map((dim) => (
                      <div key={dim} className="space-y-1">
                        ...
                        <input 
                          ...
                          className="w-full bg-black/20 border border-white/10 rounded-lg px-2 py-1.5 text-sm text-white focus:outline-none focus:border-primary/50 text-center"
                        />
                      </div>
                    ))}
                  </div>
